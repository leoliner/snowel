...
> **进度（2026-08-26）**：§2.1 与 §2.2 已完成（验收补丁计划 `plans/2026-08-26-acceptance-gap/`，merge b2022bb）——75 例终核（口径从"66 例"修正：实际表格 9 域 75 例）：70 例有锚 + 3 例真缺口当场补齐（TC-ON-08 拍合并 / TC-ON-12 灵感层 / TC-RT-05 小模型路由）+ 5 例 TC-EX 计划内豁免挂 L24（v1.1）；L22 六小修 + L20/L21 全部关闭。测试基线：后端 264/264 + 前端 74/74 + build。剩余：§2.3 人工走查 → §2.4 L16 → §2.5 发布。
...
### 2.2 L22 小补包（✅ 已完成：并入验收补丁计划 T4/T5 + 修复波，六项全落地，L20/L21 顺带关闭）
